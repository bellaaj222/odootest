odoo.define('web_gantt_compact_view_adv.WebGanttRenderer', function (require) {
    "use strict";
    ...
    var WebGanttRenderer = AbstractRenderer.extend({
        ...
        _configGantt: function () {
            ...
            gantt.templates.rightside_text = function (start, end, task) { 
                if(task.is_group){
                    var text = "";
                    var text = "<b>End Date: " + moment(task.end_date).format('YYYY-MM-DD') + "</b>";
                    return text;
                }
                if (task.deadline) {
                    var text = "";
