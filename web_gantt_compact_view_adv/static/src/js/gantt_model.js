odoo.define('web_gantt_compact_view_adv.WebGanttModel', function (require) {
    "use strict";
    ...
    var  WebGanttModel = AbstractModel.extend({
        ...
        _getDomain: function () {
            var gannt_start_date = this.stringDateToServerTime(this.gantt.start_date); //this.gantt.start_date.locale('en').format("YYYY-MM-DD");
            var gannt_to_date = this.stringDateToServerTime(this.gantt.to_date); //this.gantt.to_date.locale('en').format("YYYY-MM-DD");
